...
export const usersRouter = t.router({
  aggregateUser: shieldedProcedure.input(UserAggregateSchema).query(async ({ ctx, input }) => {
    const aggregateUser = await ctx.prisma.user.aggregate(input);
    return aggregateUser;
  }),
  createOneUser: shieldedProcedure.input(UserCreateOneSchema).mutation(async ({ ctx, input }) => {
    const createOneUser = await ctx.prisma.user.create(input);
    return createOneUser;
  }),
  deleteManyUser: shieldedProcedure.input(UserDeleteManySchema).mutation(async ({ ctx, input }) => {
    const deleteManyUser = await ctx.prisma.user.deleteMany(input);
    return deleteManyUser;
  }),
  deleteOneUser: shieldedProcedure.input(UserDeleteOneSchema).mutation(async ({ ctx, input }) => {
    const deleteOneUser = await ctx.prisma.user.delete(input);
    return deleteOneUser;
  }),
  findFirstUser: shieldedProcedure.input(UserFindFirstSchema).query(async ({ ctx, input }) => {
  ...
  findManyUser: shieldedProcedure.input(UserFindManySchema).query(async ({ ctx, input }) => {
    const findManyUser = await ctx.prisma.user.findMany(input);
    return findManyUser;
  }),
  findUniqueUser: shieldedProcedure.input(UserFindUniqueSchema).query(async ({ ctx, input }) => {
  ...
  groupByUser: shieldedProcedure.input(UserGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyUser: shieldedProcedure.input(UserUpdateManySchema).mutation(async ({ ctx, input }) => {
    const updateManyUser = await ctx.prisma.user.updateMany(input);
    return updateManyUser;
  }),
  updateOneUser: shieldedProcedure.input(UserUpdateOneSchema).mutation(async ({ ctx, input }) => {
    const updateOneUser = await ctx.prisma.user.update(input);
    return updateOneUser;
  }),
  upsertOneUser: shieldedProcedure.input(UserUpsertSchema).mutation(async ({ ctx, input }) => {
